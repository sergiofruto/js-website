  ...
  <div class="home page-template page-template-js-homepage page-template-js-homepage-php page page-id-239 layout-fullwidth layout-cover-center parallax-enabled sticky-sidebar-enabled navbar-scroll-enabled">
    ...
    {/* <div class="item">
      <div>
        <img title="HomePage Slide 03" src="http://web.archive.org/web/20190121230204im_/http://josefinasomoza.com/wp-content/uploads/2017/09/Home_3Fotos_Slider_03.jpg" alt="HomePage Slide 03"/>
         <div class="owl-carousel-item-imgoverlay"><div class="owl-carousel-item-imgtitle">HomePage Slide 03</div><div class="owl-carousel-item-imgcontent"></div></div></div>
    </div> */}
    </div>
    </div>
    <div class="flex-row">
      ...
      <div class="flex-item flex-item-4 height-2">
        <div class="hp-item-content">
          <div class="item-copy center bg-grey-2">
            <p> - </p>
    ...
    <div class="flex-row">
      <div class="flex-item flex-item-4 height-1 mobile-hidden">
        <div class="hp-item-content">
          <div class="box-fill bg-grey-3 "></div>
        </div>
      </div>
    ...
    <div class="flex-row">
      ...
      <div class="flex-item flex-item-4 height-1 mobile-hidden">
        <div class="hp-item-content">
          <div class="box-fill bg-grey-4"></div>
        </div>
      </div>
    ...
    <div class="flex-row">
      <div class="flex-item flex-item-4 height-2">
        <div class="hp-item-content">
          <div class="item-copy center bg-grey-1">
            <p> - </p>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              <form role="search" method="get" class="search-form form" action="http://web.archive.org/web/20190121230204/http://josefinasomoza.com/">
  <label class="sr-only">Search for:</label>
  <div class="input-group">
    <input type="search" value="" name="s" class="search-field form-control" placeholder="Search Josefina Somoza" required />
