      ...
      <footer class="site-footer">
        <div class="container">
          <div class="footer-info">
                          ...
                          <a href="http://web.archive.org/web/20190121230204/http://josefinasomoza.com/" class="footer-logo">
            ...
            <div class="footer-submenu">
              ...
              <ul>
                ...
                <li>
                  ...
                  <a class="footer-inner-item" href="">www.josefinasomoza.com</a>
                </li>
                <li>
                  <span class="footer-icon">
                    <svg viewbox="0 0 24 24">
                  ...
                  <a class="footer-inner-item" href="http://web.archive.org/web/20190121230204/mailto:js@josefinasomoza.com">js@josefinasomoza.com</a>
                </li>
                <li>
                  <span class="footer-icon">
                    <svg viewbox="0 0 24 24">
                  ...
                  <span class="footer-inner-item">+54 9 11 44255043</span>
                </li>
              </ul>
            </div>
            <div class="footer-submenu">
              ...
              <ul>
                ...
                <li>
                  ...
                  <a class="footer-inner-item" target="_blank" href="http://web.archive.org/web/20190121230204/https://www.instagram.com/josefinasomozainteriorismo/">/josefinasomozainteriorismo</a>
                </li>
                </ul>
            </div>
            <div class="footer-submenu">
              ...
              <ul>
                <li>-</li>
                <li>
                  <a class="footer-inner-item qr-code" href="">
