      ...
      <footer className="site-footer">
        <div className="container">
          <div className="footer-info">
            <a href="http://web.archive.org/web/20190121230204/http://josefinasomoza.com/" className="footer-logo">
            ...
            <div className="footer-submenu">
              ...
              <ul>
                ...
                <li>
                  ...
                  <a className="footer-inner-item" href="http://web.archive.org/web/20190121230204/mailto:js@josefinasomoza.com">js@josefinasomoza.com</a>
                </li>
                <li>
                  <span className="footer-icon">
                    <svg viewBox="0 0 24 24">
            ...
            <div className="footer-submenu">
              ...
              <ul>
                ...
                <li>
                  ...
                  <a className="footer-inner-item" target="_blank" href="http://web.archive.org/web/20190121230204/https://www.instagram.com/josefinasomozainteriorismo/">/josefinasomozainteriorismo</a>
                </li>
                </ul>
            </div>
            <div className="footer-submenu">
